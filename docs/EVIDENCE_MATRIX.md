...
| `event_operations_cascade` | PASS | generic changed-time graph and Alexa decision surface preserve the most net cash outside travel | impacts=5; actions=5; added_cost=620.0; avoidable_loss=5800.0; net_preserved=5180.0; external_people=8; av_choice=move_av_delivery; repair_card=$5,800 at risk → $620 repair → $5,180 net preserved; approval_cta=Approve $620 repair; top_impacts=['Catering service window', 'AV equipment delivery', 'Security staffing coverage'] |
